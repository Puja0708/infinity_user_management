...
<%@include file="Header.jsp"%>
	<div class="container">
		...
		<div id="border">
 	 <s:form name = "myForm" action="deleteoperator11" prefix="a" theme="simple" method="post">
...
<tr> 
   ...
   &nbsp;
	  ...
	  <td>	
	 <s:submit value="UPDATE" cssClass="btn btn-primary" onclick="return confirm('Are you sure you want to continue to update')"></s:submit>
     </td>
</tr>
