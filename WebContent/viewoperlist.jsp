...
<%@include file="Header.jsp"%>
	<div class="container">
		...
		<div id="border">
 	 <s:form name = "myForm" action="deleting1" >
  <table border="1">
          ...
          <tr>
           <td><s:property value="operatorId"/><s:hidden name="operatorId"  value="%{operatorId}" /></td>
          ...
          <td><s:submit value="Delete" cssClass="btn btn-primary"></s:submit></td></tr>
           </s:iterator>
